...
Q_CONSTINIT static const qt_meta_stringdata_CLASSGameSceneENDCLASS_t qt_meta_stringdata_CLASSGameSceneENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(37, 11)   // "keyReleased"
    },
    "GameScene",
    "keyPressed",
    "",
...
void GameScene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (GameScene::*)(QKeyEvent * );
            if (_t _q_method = &GameScene::keyPressed; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (GameScene::*)(QKeyEvent * );
            if (_t _q_method = &GameScene::keyReleased; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void GameScene::keyPressed(QKeyEvent * _t1)
{
...
// SIGNAL 1
void GameScene::keyReleased(QKeyEvent * _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
